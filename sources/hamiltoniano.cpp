/*
    Sebastian Gomez Gutierrez
    Dado un grafo g conexo y ponderado y dado uno de sus vértices v0, 
    encontrar el ciclo Hamiltoniano de coste mínimo que comienza y termina en v0.
    Codigo tomado de: https://www.geeksforgeeks.org/traveling-salesman-problem-using-branch-and-bound-2/
    17/04/2020
*/
#include <bits/stdc++.h> 
using namespace std; 
...
{ 
    ...
    printf("Ciclo Hamiltoniano de costo minimo : %d\n", final_res); 
